...
Scene* WorldThree::createScene(bool inGame)
{
	auto scene = Scene::create();
	auto layer = WorldThree::create();
...
bool WorldThree::init()
{
	App::get()->setCurrentWorld(2);
	...
	auto sprite = Sprite::create("papyrus_black.png");
